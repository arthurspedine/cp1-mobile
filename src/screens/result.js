  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.infoContainer}>
        <Text style={styles.texto}>Nome do Produto: {route.params?.nomeProduto}</Text>
        ...
        <Text style={{ fontWeight: 'bold', textAlign: 'center', fontSize: 16 }}>Valor Final: R${route.params?.valorFinal}</Text>
      </View>
    </View>
  );
}
